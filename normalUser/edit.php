...
if($nationality == 'مصرى'){
  ...
  $ins="UPDATE users set uname = '$name',nationality = '$nationality', nationalId = '$nationalId', phone = '$phone' , gender = '$egender', age = '$age',address = '$address', marriageAddress = '$marriageAddress',diabetes = '$diabetes', bloodPresure = '$bloodPressure',ifRelate = '$ifRelate', previousMarriage =  '$previousMarriage', childern = '$childern', geneticDiseases = '$geneticDiseases', height = '$height', weight = '$weight', bmi = '$bmi', diabetesCheck = '$diabetesCheck',systolic = '$systolic',diastolic = '$diastolic', abo = '$abo', rh =  '$rh',hb = '$hb', hbsag = '$hbsag', hcv = '$hcv', hiv = '$hiv' where serial = '$serial' ";  
...
قبل إجراءات الزواج وأصبحت بذلك مسئول عما يترتب على ذلك دون أدنى مسئولية على المنشأة الصحية والفريق الطبى الذى يمثلها  .</p><br>
  ...
  <div class="col-sm-4"><img src="https://chart.googleapis.com/chart?cht=qr&chl=Hello+World&chs=160x160&chld=L|0" class="qr-code img-thumbnail img-responsive" /></div>
    ...
    <button class="btn btn-lg text-white submitButton" type="submit" name="print"
...
if($nationality == 'غير مصرى'){
   ...
   $ins="UPDATE users set uname = '$name',country = '$nationality',nationality = '$nationality', FnationalId = '$FnationalId', phone = '$phone' , gender = '$egender', age = '$age',address = '$address', marriageAddress = '$marriageAddress',diabetes = '$diabetes', bloodPresure = '$bloodPressure',ifRelate = '$ifRelate', previousMarriage =  '$previousMarriage', childern = '$childern', geneticDiseases = '$geneticDiseases', height = '$height', weight = '$weight', bmi = '$bmi', diabetesCheck = '$diabetesCheck',systolic = '$systolic',diastolic = '$diastolic', abo = '$abo', rh =  '$rh',hb = '$hb', hbsag = '$hbsag', hcv = '$hcv', hiv = '$hiv' where serial = '$serial' ";     
